...
class Receiver(nn.Module):
    def __init__(self, img_embed_dim, game_embed_dim, word_dict_dim, img_dict_dim):
        ...
        self.img_dict_dim = img_dict_dim
    ...
    def forward(self, im1, im2, w):
        ...
        selection = np.random.choice(np.arange(self.img_dict_dim), p=prob_distribution)
